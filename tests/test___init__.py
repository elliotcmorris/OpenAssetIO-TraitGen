...
class Test_generate:
    ...
    def test_when_logger_supplied_then_called_with_child_logger_with_generator_suffix(
        self,
        yaml_path_all,
        some_output_dir,
        some_creation_callback,
    ...
    def test_when_valid_then_structure_is_logged_as_info(
        ...
        structureMsg.remove((logging.INFO, "Generating with python..."))
    ...
    def test_when_invalid_generator_cannot_find_generator_error_logged(
        self,
        yaml_path_all,
        some_output_dir,
        some_creation_callback,
        ...
        assert (logging.ERROR, "Cannot find generator Algol") in a_capturing_logger.handlers[
            0
        ].messages

    def test_when_empty_generator_error_logged(
        self,
        yaml_path_all,
        some_output_dir,
        some_creation_callback,
        ...
        assert (logging.ERROR, "No generator specified") in a_capturing_logger.handlers[0].messages
